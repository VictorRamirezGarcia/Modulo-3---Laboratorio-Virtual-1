...
console.log("Esto se puede revisar visualmente por la pagina Equipo2.html e internamente por el archivo JSON llamado doctores2.json\n");
...
console.log("Este es el nombre del primer Doctor original: " +doctores[0].nombre );
console.log("Ahora clonare los Doctores... ");
const doctoresClones = doctores;
